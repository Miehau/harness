...
Evidence: [credentials.js](../../src/credentials.js), [project-config.js](../../src/project-config.js), [http.js](../../src/http.js), [credentials tests](../../test/credentials.test.js), [project config tests](../../test/project-config.test.js).
